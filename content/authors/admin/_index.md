...
# name_pronunciation: Luke Braithwaite
...
bio: I am an MPhil ACS student at Peterhouse, University of Cambridge and my research interests are graph representation learning and geometric deep learning. My current research explores adapting sheaf-based methods for heterogeneous graph data.
...
education:
  courses:
    - course: MPhil Advanced Computer Science
      institution: University of Cambridge (Peterhouse), UK
      year: In progress
...
social:
  ...
  - icon: github
    icon_pack: fab
    link: https://github.com/AspieCoder1
  - icon: linkedin
    icon_pack: fab
    link: https://www.linkedin.com/in/luke-braithwaite/
...
My research focused on exploring sheaf-based graph neural networks for processing heterogeneous graph data and is supervised by [Prof. Pierto Liò](https://www.cl.cam.ac.uk/~pl219/).
